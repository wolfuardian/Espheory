...
//     version 1.7.0
//     from Assets/Espheory/Scripts/Player/Runtime/InputKeyMapper.inputactions
//
...
public partial class @InputKeyMapper: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @InputKeyMapper()
    {
    ...
    {
        private @InputKeyMapper m_Wrapper;
        public PlayerActions(@InputKeyMapper wrapper) { m_Wrapper = wrapper; }
