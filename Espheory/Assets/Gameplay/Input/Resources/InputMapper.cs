...
//     version 1.8.2
//     from Assets/Gameplay/Input/Resources/InputMapper.inputactions
//
...
public partial class @InputMapper: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""d209874d-4953-4f12-bb00-d803b508564f"",
    ...
    ~@InputMapper()
    {
        Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, InputMapper.Player.Disable() has not been called.");
    }
